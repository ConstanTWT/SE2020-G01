<template>
  <div class="about" style="color:white">
    ...
    <p class="name" style="color:white">try</p>
    <p class="desc">Code error rewriting</p>
    <ul class="social">
      <li><a href="https://github.com/" target="_blank"><img src="../../assets/icon/GitHub.png" alt=""></a></li>
    </ul>
    <div class="line"></div>
    <h4>访问情况</h4>
