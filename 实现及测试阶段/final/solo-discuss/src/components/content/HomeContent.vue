  ...
  <div class="home-content">
    <iv-row>
      <iv-col :xs="24" :sm="24" :md="24" :lg="17" :xl="17">
        <div class="layout-left" style="color:white">
          <section-title :mainTitle="'帖子'" :subTitle="'Articles'" :tipText="'View More'" :tipHref="'/articles'">
          ...
          <section-title :mainTitle="'标记'" :subTitle="'Notes'" :tipText="'View More'" :tipHref="'/books'">
